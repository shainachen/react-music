...
public class SpringAppContextInitializer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
    ...
    public String[] getCloudProfile(Cloud cloud) {
        ...
        if (profiles.size() > 0) {
            return createProfileNames(profiles.get(0));
        }
        return null;
    }
...
//
//    private static final Map<Class<? extends ServiceInfo>, String> serviceTypeToProfileName = new HashMap<>();
//    private static final List<String> validLocalProfiles = Arrays.asList("mysqlcloud", "postgres", "mongodb", "redis");
//
//    public static final String IN_MEMORY_PROFILE = "in-memory";
//
//    static {
//        serviceTypeToProfileName.put(MysqlServiceInfo.class, "mysqlcloud");
//    }
//
//    @Override
//    public void initialize(ConfigurableApplicationContext applicationContext) {
...
//        String[] profileNames = {baseName, baseName};
//        return profileNames;
//    }
//}